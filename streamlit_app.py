...
if scan:
    ...
    if results:
        ...
        # COLOR FIX - NEW PANDAS ME MAP USE HOTA HAI
        styled = df.style.map(lambda x: 'background-color: #ff4d4d; color: white; font-weight: bold', subset=['SL'])\
